...
export function createProductsList (productos) {
   let html = '<ul>'
...
// module.exports = {createPage,createProductsList}; viejo

//export default createPage ... genera problemas porque solo puede haber uno por página, no podemos hacerlo.

//HACEMOS ENTONCES:
//export {createPage,createProductsList};

//pero aún mejor es poner el export delante de la función.
